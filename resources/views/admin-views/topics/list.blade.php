                    ...
                    <li>
                        <div class="page-header">
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Topic List List</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><span>Topic List List</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <div class="th-content">Sub Category</div>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @foreach ($topic as $index => $topic)
                                        <td>
                                            {{ $index + 1 }}
                                        </td>
                                        <td><img src="{{ URL::to('/topic/', $topic->image) }}" width="200"
                                                height="100"></td>
                                        <td>{{ $topic->name }}</td>
                                        <td>{{ $topic->slug }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('admin.topic.delete', $topic->id) }}"

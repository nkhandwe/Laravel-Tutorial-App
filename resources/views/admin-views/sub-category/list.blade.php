                    ...
                    <li>
                        <div class="page-header">
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Sub Category List</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><span>Sub Category List</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @foreach ($subcate as $index => $subcate)
                                        ...
                                        <td><img src="{{ URL::to('/sub-category/', $subcate->image) }}" width="200"
                                                height="100"></td>
                                        <td>{{ $subcate->name }}</td>
                                        <td>{{ $subcate->slug }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('admin.sub-category.delete', $subcate->id) }}"

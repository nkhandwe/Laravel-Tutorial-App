...
<head>
    ...
    <link href="{{ url('plugins/owl-carousel/owl.carousel.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ url('plugins/owl-carousel/owl.theme.default.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ url('assets/css/authentication/auth_1.css') }}" rel="stylesheet" type="text/css">
...
<body class="login-one">
    ...
    <div id="load_screen">
        ...
        <p class="neptune-loader-heading">Learning App</p>
    </div>
    <!--  Loader Ends -->
    <!-- Main Body Starts -->
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 p-0">
                    <div class="login-one-start">
                        ...
                        <div class="login-one-inputs social-logins mt-4">
                            <div class="social-btn"><a href="#" class="fb-btn"><i
                    ...
                    <div class="slider-half">
                        <div class="slide-content">
                            {{-- <div class="top-sign-up ">
                                <div class="about-comp text-white mt-2">Learning App</div>
    ...
    <script src="{{ url('assets/js/authentication/auth_1.js') }}"></script>

                        ...
                        <div class="page-header">
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><span>Post List</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <div class="th-content">Topic</div>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @foreach ($post as $index => $topic)
                                        <td>
                                            {{ $index + 1 }}
                                        </td>
                                        <td><img src="{{ URL::to('/post/', $topic->image) }}" width="200" height="100">
                                        </td>
                                        <td>{{ $topic->name }}</td>
                                        <td>{{ $topic->slug }}</td>
